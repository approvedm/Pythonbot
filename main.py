...
BOT_TOKEN = "6552879262:AAEfXY71tegNPGfofsqFqPzvVoc_kUDOr8c"
PAYMENT_CHANNEL = "@selfserverBo" #add payment channel here including the '@' sign
OWNER_ID = 6743864474 #write owner's user id here.. get it from @MissRose_Bot by /id
CHANNELS = ["@selfserverBo"] #add channels to be checked here in the format - ["Channel 1", "Channel 2"] 
...
def amo_with(message):
   try:
    ...
    send = bot.send_message(-1002073430860,  "✅* New Withdraw\n\n⭐ Amount - "+str(amo)+f" {TOKEN}\n🦁 User - @"+message.from_user.username+"\n💠 Wallet* - `"+data['wallet'][user]+"`\n☎️ *User Referrals = "+str(
